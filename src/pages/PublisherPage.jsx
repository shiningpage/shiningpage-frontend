...
class PublisherPage extends Component {
    ...
    async componentDidMount() {
        ...
        setTimeout(async() => { // setTimeout برای اجرای کامل scrollToTop است
            ...
            await this.props.dispatch(setPageName('publisher'))
    ...
    getUsernameInfo = async (p1, root) => {
        ...
        try {
            ...
            if (root==='user') {
                this.props.dispatch(setPageName('user'))
            }
    ...
    render() {
        ...
        const {rtl, lang, setLT, pageYOffset, fullAccess, geo, userId, mainUser, mainUserId, subUserInfo, isAuthenticated, userServiceSelected, 
